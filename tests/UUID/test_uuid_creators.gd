...
func _run_test() -> int:
	...
	TEST_EQ('', v3_invalid_ns, "create_v3_godot_string(invalid ns) == empty string")
	...
	TEST_EQ('', UUID.create_v5_stduuid_string("test_seed", "invalid"), "create_v5_stduuid_string(invalid ns) = empty string")
