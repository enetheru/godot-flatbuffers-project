...
const schema_root = 'res://tests/schemas/include.fbs'
const schema_other = 'res://tests/schemas/other.fbs'
const output_path = 'res://tests/generated/'
...
func _run_test() -> int:
	...
	logp( FlatBuffersPlugin.generate(schema_root, ['--gdscript']) )
