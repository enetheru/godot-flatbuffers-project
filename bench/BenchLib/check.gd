...
# destructed.
static func CheckHandler( _call_site:String, _msg:String ) -> Log.LogType:
	return null
#class CheckHandler {
 #public:
...
static func BM_CHECK(b:bool, msg:String = "") -> Log.LogType:
	return Log.GetNullLogInstance() if b else \
	CheckHandler(get_call_site(), msg)#.GetLog()
